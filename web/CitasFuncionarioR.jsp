        ...
        <form action="Servlet" method="POST">
            <header class="masthead bg-primary text-white text-center">
                <div class="container d-flex align-items-center flex-column">
                    <h1 class="masthead-heading text-uppercase mb-0">APPOINTMENTS</h1>
            ...
            <sql:query var="result" dataSource="${snapshot}">
                select distinct patient.namep, patient.firslastn, patient.seclastname, AppoDates.appoDate, AppoState.appoState, HealthArea.area from Appointments inner join HealthArea on Appointments.idHarea= HealthArea.idHArea inner join AppoDates on Appointments.idAppo = AppoDates.idAppo inner join AppoState on Appointments.idAppo = AppoState.idAppo inner join patient on Appointments.ident = patient.ident
